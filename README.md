...
| [**API Layer Codegen MCP**](./api-layer-codegen-mcp) | OpenAPI 탐지 → TypeScript/Zod/TanStack Query API 레이어 생성까지 stdio 하네스로 검증하는 MCP 서버 | TypeScript · MCP · OpenAPI · Zod · TanStack Query | [Local](./api-layer-codegen-mcp) |
