...
| [**MCP Codegen Agent Harness**](./mcp-codegen-harness) | OpenAPI 탐지 → TypeScript/Zod/TanStack Query 코드 생성까지 stdio 하네스로 검증하는 MCP 서버 | TypeScript · MCP · OpenAPI · Zod · TanStack Query | [Local](./mcp-codegen-harness) |
