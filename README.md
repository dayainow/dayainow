...
| 프로젝트 | 한 줄 소개 | 역할·기술 | 링크 |
| --- | --- | --- | --- |
| [**CorpBrain**](https://github.com/dayainow/corp-brain) | 엔터프라이즈급 권한(RBAC) 기반 로컬 RAG 사내 문서 챗봇 시스템 | Next.js · Ollama · AI SDK | [GitHub](https://github.com/dayainow/corp-brain) |
